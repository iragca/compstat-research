...
│                         compstat_research and configuration for tools like black
│
...
│
└── compstat_research   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes compstat_research a Python module
    │
